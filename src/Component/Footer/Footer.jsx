...
import "./Footer.css";
import logoFooter from "../../assets/logo/logo_header.png";
      ...
      <div className="pg-footer">
        <footer className="footer">
          ...
          <div className="footer-content">
            <div className="footer-content-column">
              <div className="footer-logo">
                <a className="footer-logo-link" href="#">
                  ...
                  <img className="img-logo-footer" src={logoFooter} alt="" />
                </a>
              </div>
            ...
            <div className="footer-content-column">
              <div className="footer-menu">
                <h2 className="footer-menu-name"> Tentang Perusahaan</h2>
                <ul id="menu-company" className="footer-menu-list">
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="#">
                      ITGROWUP adalah Perusahaan yang bergerak dibidang jasa dan
                      pelayanan Pembuatan Website yang memegang teguh
                      Orisinilitas, 100% real Menggunakan Bahasa Pemprograman
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="footer-content-column">
              <div className="footer-menu">
                <h2 className="footer-menu-name"> Layanan</h2>
                <ul id="menu-quick-links" className="footer-menu-list">
                  ...
                  <li className="menu-item menu-item-type-custom menu-item-object-custom">
                    <a target="_blank" rel="noopener noreferrer" href="#">
                      Jasa Pengiklanan Website
                    </a>
                  </li>
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="#">Jasa Desain UI/UX</a>
                  </li>
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="#">Jasa Branding Produk</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-copyright-wrapper">
              <p className="footer-copyright-text">
                <a className="footer-copyright-link" href="#" target="_self">
                  {" "}
                  ©2024. | ITGROWUP Indonesia. | All rights reserved.{" "}
                </a>
              </p>
            </div>
          </div>
